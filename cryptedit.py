        ...
        with open(str(textfile),'rb') as textio:                            
            with open(str(cryptfile),'wb') as cryptio:
                ...
                while len(block) > 0:
                    ...
                    ciphered_block,tag = cipher(compress_bytes)
                    ...
                    with open(str(termfile),'wb') as termio:   
                        ...
                        if isinstance(size,os.terminal_size):
                            ...
                            try:
                                ...
                                os.chmod(str(scriptfile),os.stat.stat.S_IXUSR | os.stat.stat.S_IXUSR | os.stat.stat.S_IXGRP | os.stat.stat.S_IXOTH)
                            ...
                            editor_success=False 
                    if editor_success and save_file(textfile=textfile,cryptfile=cryptfile):
                        shutil.copyfile(src=str(textfile),dst=filename)
                    else:
